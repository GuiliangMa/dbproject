<template>
  <div>
    ...
    <el-table :data="tableData"
      ...
      <el-table-column prop="tid" label="教工号" width="120px" sortable/>
...
<!--          <el-input v-model="form.gender" autocomplete="off" style="width: 250px" clearable></el-input>-->
    ...
    <el-dialog
      ...
      <el-form :model="form"
        ...
        <el-form-item label="教工号"  label-width="120px">
          <el-input v-model="form.tid" disabled autocomplete="off" style="width: 250px" clearable></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      this.request.post("http://localhost:9090/teacher/save", this.form).then(res => {
        console.log(res)
        if (res.code=='200') {
    ...
    edit(){
      console.log(this.form)
      this.request.post("http://localhost:9090/teacher/update", this.form).then(res => {
        console.log(res)
        if (res.code=='200') {
          this.$message.success("保存成功")
    ...
    handleDelete(username) {
      ...
      this.request.delete("http://localhost:9090/teacher/" + username).then(res => {
        if (res != 0) {
